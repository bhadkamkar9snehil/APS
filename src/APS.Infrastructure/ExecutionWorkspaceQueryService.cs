...
public sealed class ExecutionWorkspaceQueryService(
    ApsDbContext db,
    IPlannerWorkspaceQueryService plannerWorkspace) : IExecutionWorkspaceQueryService
{
        ...
        CancellationToken cancellationToken = default)
    {
        var plan = planVersionId.HasValue
            ? await plannerWorkspace.GetPlanContextAsync(planVersionId.Value, cancellationToken)
            : await plannerWorkspace.GetCurrentPlanAsync(cancellationToken);
...
public sealed class UnavailableExecutionWorkspaceQueryService : IExecutionWorkspaceQueryService
{
